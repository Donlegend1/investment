                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        <div class="title-content">
                            <h2 class="title">{{ __('Add New Stake') }}</h2>
                        ...
                        <div class="site-card-body">
                            <form action="{{route('admin.schema.store')}}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="col-xl-6 schema-name">
                                    <div class="site-input-groups">
                                        <label class="box-input-label" for="">{{ __('Stake Name:') }}</label>
                                        <input
                                            type="text"
                                            name="name"
                                            class="box-input"
                                ...
                                <div class="col-xl-6 schema-badge">
                                    <div class="site-input-groups">
                                        <label class="box-input-label" for="">{{ __('Stake Badge:') }}</label>
                                        <input
                                            type="text"
                                            class="box-input"
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        <label class="box-input-label" for="">{{ __('Stake Type:') }}</label>
